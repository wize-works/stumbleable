/**
 * Email Service Client for Crawler Service
 * Handles sending submission-related emails via the email service API
 */
...
export class EmailClient {
    ...
    static async sendSubmissionReceivedEmail(
        ...
        return this.queueEmail({
            ...
            email_type: 'submission-received',
            subject: 'We received your content submission - Stumbleable',
            template_data: {
                email: email,
